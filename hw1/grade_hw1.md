...
- Q4 (9/10)
  ...
  - Q4.1. Run the `wget` command to download `pg42671.txt` in the background by `#| eval: true`. `-1.0`
  
- Q5 (10/10)

- Q6 (8/10)

  - No screenshot is displayed in the rendering on my laptop, nor was it submitted as a separate file. `-2.0`
